    ...
    <>
      <div className="card">
        <form onSubmit={onSubmit} style={{ minWidth: 400 }}>
          ...
          <input type="text" name="client_id" placeholder="Client ID" defaultValue={connection.client_id} />
          <label htmlFor="client_secret">Client Secret</label>
          <input type="text" name="client_secret" placeholder="Client Secret" defaultValue={connection.client_secret} />
          <label htmlFor="issuer">Issuer URL</label>
          <input type="text" name="issuer" placeholder="Issuer" defaultValue={connection.issuer} />
          <hr />
          <h5>
          ...
          <div className="panel">
            <div className={'panel-contents'}>
              ...
              <input type="text" name="token_url" placeholder="Token URL" defaultValue={connection.token_url} />
              ...
              <input type="text" name="jwks_url" placeholder="Jwks URL" defaultValue={connection.jwks_url} />
            </div>
          </div>
